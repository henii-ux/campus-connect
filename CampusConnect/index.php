...
<body class="bg-white text-gray-800">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Dynamic extra field for signup (Student ID or Department)
            const signupUserType = document.getElementById('signup-user-type');
            const signupExtraField = document.getElementById('signup-extra-field');
            function updateSignupExtraField() {
                if (signupUserType.value === 'student') {
                    signupExtraField.innerHTML = '';
                } else {
                    signupExtraField.innerHTML = '';
                }
            }
            signupUserType.addEventListener('change', updateSignupExtraField);
            updateSignupExtraField();
            ...
            document.getElementById('signup-form').addEventListener('submit', function(e) {
                ...
                fetch("signup.php", {
                    ...
                    body: new URLSearchParams({
                        ...
                        password,
                        role: userType,
                        department: userType === "student" ? "Student Dept" : "Admin Dept"
                    })
                })
                .then(res => res.json())
                .then(data => {
                    if (data.status === "success") {
                        window.location.href = userType === 'admin' ? 'admin.php' : 'main.php';
                    } else {
            ...
            document.getElementById('login-form').addEventListener('submit', function(e) {
                ...
                .then(data => {
                    if (data.status === "success") {
                        ...
                        window.location.href = data.role === "admin" ? "admin.php" : "main.php";
                    } else {
